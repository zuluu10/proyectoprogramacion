...
# Crear botones
botonplay = Boton(100, 0, 417, 250, play)
botonplay2 = Boton(700, 450, 300, 150, play)
botonhelp = Boton(100, 150, 417, 250, help)
botonquit = Boton(100, 300, 417, 250, quit)
...
def menu_seleccion():
    ...
    while ejecutando_menu_seleccion:
        ...
        texto_rondas = font.render(f"Nº de rondas: {num_rondas}", True, COLOR_NEGRO)
        ...
        texto_jugadores = font.render(f"Nº de jugadores: {n_jugadores}", True, COLOR_NEGRO)
        ...
        botonplay2.draw(PANTALLA)
        if botonplay2.is_clicked():
            current_screen = 'game'
...
while ejecuta:
    ...
    elif current_screen == 'menu_seleccion':
        menu_seleccion()
