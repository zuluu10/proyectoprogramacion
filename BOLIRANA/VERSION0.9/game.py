...
canica = pygame.transform.scale(canica, (50,50))
...
salto1 = pygame.image.load('imagenes/Salto/Jump.png')
...
def recargaPantalla():
    ...
    global cuentaPasos, lanzado, cuentaLanzamiento, salto, cuentaSalto, cuentaSalto_lista
